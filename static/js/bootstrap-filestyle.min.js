(function(c){var b=function(d,e){
    ...
    c.fn.filestyle.defaults={buttonText:"Seleccionar",iconName:"icon-folder-open",buttonName:"btn-default",size:"nr",input:true,badge:true,icon:true,buttonBefore:false,disabled:false};
