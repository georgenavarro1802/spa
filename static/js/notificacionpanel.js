...
NOTIFICACION_INFO = 3;
NOTIFICACION_EXITO = 4;

function defaultFor(arg, val) { return typeof arg !== 'undefined' ? arg : val; }

iconoNotificacion = function(t) {
    if (t==NOTIFICACION_ALERTA) {
        return "<img src='/static/images/dalerta.png' alt='ALERTA' width='40px'/>";
    } else if (t==NOTIFICACION_ERROR) {
        return "<img src='/static/images/derror.png' alt='ERROR' width='40px'/>";
    } else if (t==NOTIFICACION_INFO) {
        return "<img src='/static/images/dinfo.png' alt='INFO' width='40px'/>";
    }else if (t==NOTIFICACION_EXITO) {
        return "<img src='/static/images/dexito.png' alt='EXITO' width='40px'/>";
    }
};
...
notificarExito = function(titulo, mensaje, boton, fboton) {
    mostrarNotificacionPanel(NOTIFICACION_EXITO, titulo, mensaje, boton1='', fboton1=null, boton2=boton, fboton2=fboton);
};
...
mostrarNotificacionPanel = function(tipo, titulo, mensaje, boton1, fboton1, boton2, fboton2) {
    ...
    $("#notificacionpanel .panelbody").html("<table><tr><td width='50px'>"+iconoNotificacion(tipo)+"</td><td valign='top'>"+mensaje+"</td></tr></table>");
    if (boton1.length>0) {
    ...
    $("#notificacionpanel").modal({backdrop: 'static', keyboard: false, width: '600px'});
